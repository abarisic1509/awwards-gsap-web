                ...
                >
                  <article className="flex-1 grid grid-rows-[1fr_auto]">
                    ...
                    <img
                      ...
                      alt=""
                      className="ol-start-1 col-end-2 row-start-1 row-end-3 w-full h-full object-cover rounded-2xl"
                    />

                    <img
                      src={`/images/${flavor.color}-drink.webp`}
                      alt=""
                      className="ol-start-1 col-end-2 row-start-1 row-end-3 w-full h-full object-contain"
                    />

                    <img
                      src={`/images/${flavor.color}-elements.webp`}
                      alt=""
                      className="ol-start-1 col-end-2 row-start-1 row-end-3 w-full h-full object-contain object-center"
                    />
